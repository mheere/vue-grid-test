...
//import { getColumns, createData, getRandomArrayEntry } from 'vue-grid-advanced';
//@ts-ignore
import { VGrid, VGridSettings, CellStyleInfo, GridStateInfo, GridColumn, UpdateRowInfo } from 'vue-grid-advanced';
//@ts-ignore
import { getColumns, createData, getRandomArrayEntry, HeaderInfo } from 'vue-grid-advanced';
...
let createGrid = function () {
    ...
    settings.columns.find(c => c.dbName.isSame("img")).visible = false;
